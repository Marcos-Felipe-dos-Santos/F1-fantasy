...
describe('pontoNoTracado sobre tracadoSuavizado — goldens bit a bit', () => {
  ...
  const GOLDEN_PONTO: Record<string, [number, number][]> = {
    ...
    'pista-monza': [[134, 408], [305.01365387657546, 193.83185621458716], [471.11883845621475, 84.33900439645318], [807.3397343114143, 392.2548653938632], [527.5470732262003, 538.3431733322224], [132.39444929621803, 409.4938359282836]],
